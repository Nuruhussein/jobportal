...
return (
    // <footer className="text-gray-500 bg-white px-4 max-w-screen-2xl py-5  md:px-12">
    //     <div className="gap-6 justify-between md:flex">
    //         <div className="flex-1">
    //             <div className="max-w-xs">
    //                 <img src="https://www.floatui.com/logo.svg" className="w-32" />
    //                 <p className="leading-relaxed mt-2 text-[15px]">
    //                     Lorem Ipsum has been the industs standard dummy text ever since the 1500s.
    //                 </p>
    //             </div>
    //             <form 
    ...
    // </footer>
    <footer class="text-gray-600 bg-gray-50 border-t-2 py-10 shadow-sm  body-font">
